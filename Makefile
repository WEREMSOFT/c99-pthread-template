...
.PHONY: main_no_threads web_no_threads web test run_% debug_optimized debug_unoptimized print_information create_folder_structure run_html_u run_html_o run_performance_test init_project
...
web_no_threads: 
	$(EMSC_CC_COMMAND) -g4 --source-map-base http://127.0.0.1:5500/html/ $(SRC_D)main.c -o $(HTML_D)main_no_threads.html $(EMSC_STATIC_LIBS_D)
	cp -r src html/src
