...
var ASM_CONSTS = {
  3942: function() {postMessage({cmd : 'processQueuedMainThreadWork'})},  
 3993: function($0) {if (!ENVIRONMENT_IS_PTHREAD) { if (!PThread.pthreads[$0] || !PThread.pthreads[$0].worker) { return 0; } PThread.pthreads[$0].worker.postMessage({cmd : 'processThreadQueue'}); } else { postMessage({targetThread : $0, cmd : 'processThreadQueue'}); } return 1;},  
 4361: function() {return !!(Module['canvas'])},  
 4397: function() {noExitRuntime = true}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=8160;function _emscripten_futex_wake(addr, count) {
